...
/**
 ** \file ..\gcpql_query_parser.h
 ** Define the gcpql_query::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_GCPQL_QUERY_PARSER_H_INCLUDED
# define YY_YY_GCPQL_QUERY_PARSER_H_INCLUDED
...
namespace gcpql_query {
  ...
  public:
    ...
    Parser (class Driver& driver_yyarg, class Runner& runner_yyarg);
    virtual ~Parser ();
...
#endif // !YY_YY_GCPQL_QUERY_PARSER_H_INCLUDED
